		...
		while(true)
			{
				...
				OutputStream out = new DataOutputStream(new BufferedOutputStream(cSocket.getOutputStream()));
				
				
				
				//Downloading the HTML Code of URL and writing it into a html File named data.html
				...
				//Sending the HMTL-file data.html back to the Client
